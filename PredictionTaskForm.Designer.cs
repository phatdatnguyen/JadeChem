...
namespace JadeChem
{
    partial class PredictionTaskForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            inputForFeatureExtractionColumn = new DataGridViewCheckBoxColumn();
            inputForModelColumn = new DataGridViewCheckBoxColumn();
            outputColumn = new DataGridViewCheckBoxColumn();
            featureExtractionGroupBox = new GroupBox();
            editFeatureExtractionButton = new Button();
            featureExtractionListBox = new ListBox();
            ...
            featureExtractionGroupBox.SuspendLayout();
            ...
            workflowDiagramControl.Location = new Point(5, 5);
            workflowDiagramControl.Margin = new Padding(5);
            workflowDiagramControl.Name = "workflowDiagramControl";
            workflowDiagramControl.Size = new Size(934, 152);
            workflowDiagramControl.TabIndex = 0;
            ...
            // inputDataPanel
            // 
            inputDataPanel.Controls.Add(viewMoleculeButton);
            ...
            viewMoleculeButton.Location = new Point(3, 57);
            viewMoleculeButton.Margin = new Padding(4, 3, 4, 3);
            viewMoleculeButton.Name = "viewMoleculeButton";
            viewMoleculeButton.Size = new Size(102, 23);
            viewMoleculeButton.TabIndex = 2;
            viewMoleculeButton.Text = "View molecule...";
            viewMoleculeButton.UseVisualStyleBackColor = true;
            viewMoleculeButton.Click += ViewMoleculeButton_Click;
            // 
            ...
            inputDataDataGridView.SelectionChanged += InputDataDataGridView_SelectionChanged;
            // 
            ...
            dataProcessingTableLayoutPanel.Controls.Add(featureExtractionGroupBox, 1, 0);
            dataProcessingTableLayoutPanel.Controls.Add(processingStepsGroupBox, 1, 1);
            ...
            dataProcessingTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            dataProcessingTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            ...
            predictionTypeGroupBox.Size = new Size(372, 173);
            ...
            regressionRadioButton.Location = new Point(23, 96);
            ...
            multiclassClassificationRadioButton.Location = new Point(23, 62);
            ...
            binaryClassificationRadioButton.Location = new Point(23, 29);
            ...
            inputAndOutputColumnsGroupBox.Location = new Point(4, 182);
            ...
            inputAndOutputColumnsGroupBox.Size = new Size(372, 174);
            ...
            columnsDataGridView.Size = new Size(364, 152);
            ...
            columnColumn.Width = 140;
            // 
            // inputForFeatureExtractionColumn
            // 
            inputForFeatureExtractionColumn.HeaderText = "Input for feature extraction";
            inputForFeatureExtractionColumn.MinimumWidth = 6;
            inputForFeatureExtractionColumn.Name = "inputForFeatureExtractionColumn";
            inputForFeatureExtractionColumn.Width = 80;
            // 
            // inputForModelColumn
            // 
            inputForModelColumn.HeaderText = "Input for model";
            inputForModelColumn.MinimumWidth = 6;
            inputForModelColumn.Name = "inputForModelColumn";
            inputForModelColumn.Resizable = DataGridViewTriState.True;
            inputForModelColumn.SortMode = DataGridViewColumnSortMode.Automatic;
            inputForModelColumn.Width = 60;
            // 
            // outputColumn
            // 
            ...
            // 
            // featureExtractionGroupBox
            // 
            featureExtractionGroupBox.Controls.Add(editFeatureExtractionButton);
            featureExtractionGroupBox.Controls.Add(featureExtractionListBox);
            featureExtractionGroupBox.Dock = DockStyle.Fill;
            featureExtractionGroupBox.Location = new Point(384, 3);
            featureExtractionGroupBox.Margin = new Padding(4, 3, 4, 3);
            featureExtractionGroupBox.Name = "featureExtractionGroupBox";
            featureExtractionGroupBox.Padding = new Padding(4, 3, 4, 3);
            featureExtractionGroupBox.Size = new Size(312, 173);
            featureExtractionGroupBox.TabIndex = 2;
            featureExtractionGroupBox.TabStop = false;
            featureExtractionGroupBox.Text = "Feature extraction";
            // 
            // editFeatureExtractionButton
            // 
            editFeatureExtractionButton.Location = new Point(229, 22);
            editFeatureExtractionButton.Margin = new Padding(4, 3, 4, 3);
            editFeatureExtractionButton.Name = "editFeatureExtractionButton";
            editFeatureExtractionButton.Size = new Size(75, 23);
            editFeatureExtractionButton.TabIndex = 1;
            editFeatureExtractionButton.Text = "Edit...";
            editFeatureExtractionButton.UseVisualStyleBackColor = true;
            editFeatureExtractionButton.Click += EditFeatureExtractionButton_Click;
            // 
            // featureExtractionListBox
            // 
            featureExtractionListBox.Dock = DockStyle.Left;
            featureExtractionListBox.FormattingEnabled = true;
            featureExtractionListBox.HorizontalScrollbar = true;
            featureExtractionListBox.ItemHeight = 15;
            featureExtractionListBox.Location = new Point(4, 19);
            featureExtractionListBox.Margin = new Padding(4, 3, 4, 3);
            featureExtractionListBox.Name = "featureExtractionListBox";
            featureExtractionListBox.Size = new Size(217, 151);
            featureExtractionListBox.TabIndex = 0;
            // 
            ...
            processingStepsGroupBox.Location = new Point(384, 182);
            ...
            processingStepsGroupBox.Size = new Size(312, 174);
            ...
            processingStepsListBox.Size = new Size(217, 152);
            ...
            processDataGroupBox.TabIndex = 4;
            ...
            featureExtractionGroupBox.ResumeLayout(false);
        ...
        private GroupBox featureExtractionGroupBox;
        private GroupBox processDataGroupBox;
        private Button editFeatureExtractionButton;
        private ListBox featureExtractionListBox;
        ...
        private Button viewMoleculeButton;
        ...
        private DataGridViewCheckBoxColumn inputForFeatureExtractionColumn;
        private DataGridViewCheckBoxColumn inputForModelColumn;
